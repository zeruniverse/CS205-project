...
void compute_smoothness_mpi(image_t *dst_horiz, image_t *dst_vert, const image_t *uu, const image_t *vv, const image_t *smooth_weight, const convolution_t *deriv_flow, const float quarter_alpha);
