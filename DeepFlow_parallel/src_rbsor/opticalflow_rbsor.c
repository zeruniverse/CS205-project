...
#include "opticalflow_rbsor.h"
#include "opticalflow_aux_rbsor.h"
#include "solver_rbsor.h"
...
void compute_one_level(image_t *wx, image_t *wy, color_image_t *im1, color_image_t *im2, image_t *desc_flow_x, image_t *desc_flow_y, image_t *desc_weight, const optical_flow_params_t *params){ 
    ...
    for(i_inner_iteration = 0 ; i_inner_iteration < params->n_inner_iteration ; i_inner_iteration++){
        ...
        compute_smoothness_mpi(smooth_horiz, smooth_vert, uu, vv, smooth_weight, deriv_flow, half_alpha );
        ...
        // solve system
        sor_coupled_rbsor(du, dv, a11, a12, a22, b1, b2, smooth_horiz, smooth_vert, params->n_solver_iteration,
                        params->sor_omega);
...
void optical_flow(image_t *wx, image_t *wy, const color_image_t *im1, const color_image_t *im2, optical_flow_params_t *params, const image_t *match_x, const image_t *match_y, image_t *match_z){
    ...
    // INSPECT convolution_new is very fast (and very few calls)
    ...
    // INSPECT can't do anything with color_image_new
    color_image_t *smooth_im1 = color_image_new(width, height), *smooth_im2 = color_image_new(width, height);
    // INSPECT gaussian_filter is very fast and only has very few calls
    ...
    // INSPECT until now everything is fast
